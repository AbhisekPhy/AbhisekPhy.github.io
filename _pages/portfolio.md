...
Superconductivity, characterized by the pairing wavefunction of the Copoper pairs, can be destroyed even when the pairing amplitude remains finite. This happens in strongly disordered thin-films when the phase coherence of the Cooper pairs is lost, leading to the superconductor-insulator transition (SIT). While the single-particle density of states (DOS) remains gapped across the transition, the low-energy excitations of this system are the dynamical fluctuations of the amplitude (Higgs) and phase (Goldstone mode) of the complex order parameter. The physics of SIT in thin-film superconductors can be modelled using the inhomogeneous Bogoliubov de-Gennes (BdG) mean-field theory, which treats the effects of disorder exactly. This theory is extremely successful in capturing the physics of SIT in thin-film superconductors qualitatively, it misses the fluctuations (both quantum and thermal) completely. In our work, we develop a functional integral formalism and derive an effective bosnoic action for disordered superconductors, where the BdG theory remians as the static spatially-inhomogeneous saddle point and fluctuations are added around that. We have studied the evolution of the Higgs and the Goldstone modes with disorder and temperature. We have shown that in presence of weak disorder, the Higgs mode forms a subgap mode, spectrally separated from the Goldstone mode for a large range of temperatures, thereby making it a possible candidate to observe in energy-resolved spectroscopies.
